...
- **Secuencias de estudio:** ¿Cómo transita entre recursos? (análisis de N-gramas)
...
### Modelo Principal: Predicción desde Semana 6+ (ROC-AUC 0.90)
...
### Modelo Temprano: Predicción desde Semana 4 SIN Evaluaciones (ROC-AUC 0.74)

Para intervención **ANTES** de que existan recursos de evaluación en el curso:

| Métrica | Valor | Interpretación |
|---------|-------|----------------|
| **Capacidad predictiva (ROC-AUC)** | **0.74** | Buena discriminación |
...
> **Nota:** Métricas de sesiones totales, frecuencia y gap se detallan en la tabla resumen de 6 dimensiones anterior.
...
> **Hallazgo:** Los estudiantes aprobados **aprovechan el fin de semana** para estudiar, especialmente las tardes del sábado/domingo (% Tarde Fds: 6.4% vs 2.7%, ver tabla de dimensiones clave). Este patrón sugiere mayor compromiso con el curso más allá del horario laboral.
...
| Métrica | Valor | Interpretación |
|---------|-------|----------------|
| **ROC-AUC** | **0.90** | Excelente discriminación |
...
| Métrica | Valor | Interpretación |
|---------|-------|----------------|
| **ROC-AUC** | **0.74** | Buena discriminación |
...
| Método de Detección | Disponibilidad | Recall | Accuracy | ROC-AUC |
|---------------------|----------------|--------|----------|---------|
...
| Modelo | ROC-AUC | Accuracy | Recall | Disponible desde |
|--------|---------|----------|--------|------------------|
...
Con un AUC de 0.69-0.94 en validación LOCO (Leave-One-Course-Out), el sistema puede aplicarse a cursos que no fueron parte del entrenamiento.
...
### Indicadores de Transición (N-gramas)
